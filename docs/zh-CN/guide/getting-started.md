...
**Unplugin Torbo Console** 是一个通用型插件，旨在增强前端开发人员在使用 `console` 时的开发者体验(DX)。它拥有许多实用的功能与丰富的可配置项，得益于[Unplugin](https://unplugin.unjs.io)，它几乎适用于所有现代前端开发框架。你可以从下面的动图中看到它的部分功能：
